...
let useResize = window.innerWidth === canvas.width || window.innerHeight === canvas.width;
...
function mousemove(e) {
    ...
    var canvasX = e.clientX - cRect.left;        // Subtract the 'left' of the canvas from the X/Y
    var canvasY = e.clientY - cRect.top;  
    gl.uniform2f(mouseLocation, ((canvasX/canvas.width-.5)*canvas.width)/canvas.height, .5-canvasY/canvas.height);
    console.log(canvasX/window.innerWidth-.5, .5-canvasY/canvas.height, mouseLocation);
}
